...
export const ENEMIES: Record<string, EnemyTemplate> = {
  slime: {
    key: 'slime', name: 'Слизень',
    hp: 14, speed: 70, contactDmg: 8,
    body: 0x7be07b, accent: 0x2f6f3a, size: 18,
  },
  goblin: {
    key: 'goblin', name: 'Гоблин',
    hp: 22, speed: 110, contactDmg: 10,
    body: 0x8acb6b, accent: 0x2c4d2a, size: 16,
  },
  archer: {
    key: 'archer', name: 'Лучник',
    hp: 18, speed: 80, contactDmg: 6,
    body: 0xc084ff, accent: 0x4d2c80, size: 16,
    ranged: { range: 240, cooldown: 1500, speed: 320, dmg: 10 },
  },
  brute: {
    key: 'brute', name: 'Громила',
    hp: 60, speed: 60, contactDmg: 18,
    body: 0xa3754d, accent: 0x4b2f1d, size: 24,
  },
  boss: {
    key: 'boss', name: 'Босс',
    hp: 280, speed: 75, contactDmg: 22,
    body: 0xff5d6c, accent: 0x6e1f2a, size: 36,
